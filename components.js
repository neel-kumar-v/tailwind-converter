class SVGIcon extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.innerHTML = `
    <svg class="w-${width} aspect-square stroke-1" fill="#ffffff" fill-opacity="${opacity / 100}" viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
